...
"[project]/src/lib/admin/users.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const createUser = (data)=>apiFetch("/api/admin/users", {
        method: "POST",
        body: JSON.stringify({
            user: data
        })
    });
const updateUser = (id, role)=>apiFetch(`/api/admin/users/${id}`, {
        method: "PATCH",
        body: JSON.stringify({
            user: {
                role
...
const deleteUser = (id)=>apiFetch(`/api/admin/users/${id}`, {
        method: "DELETE"
    });
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$admin$2f$users$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/admin/users.ts [app-client] (ecmascript)");
;
...
function UsersPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "UsersPage.useEffect": ()=>{
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$admin$2f$users$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getUsers"])().then(setUsers);
        }
    }["UsersPage.useEffect"], []);
...
//# sourceMappingURL=src_ba605350._.js.map